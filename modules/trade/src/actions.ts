...
import { z } from 'zod';
import { billInput, boardInput, boardOutput, cancelBillingInput, cancelFulfillmentInput, closeInput, command, convertInput, detailOutput, fulfillInput } from './contract.ts';
