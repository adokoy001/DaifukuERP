...
export const FiscalYear = defineEntity({
  ...
  fields: {
    code: f.text({ label: label('年度コード', 'Code'), description: label('例: FY2026（開始日の暦年）', 'e.g. FY2026 (calendar year of the start date)'), required: true, unique: true, maxLength: 20 }),
