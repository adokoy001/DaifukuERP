...
export interface PayInput { period: string; employmentStart: string; employmentEnd: string; terms: readonly PayTerms[]; days: readonly PayDay[]; leaves: readonly PayLeave[]; workSystems?: readonly WorkSystemInput[]; boundaryLeaves?: readonly PayLeave[] }
