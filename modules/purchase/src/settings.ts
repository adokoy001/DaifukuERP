...
export const PURCHASE_ACCOUNTS_DEFAULT: PurchaseAccountCodes = { purchases: '5000', payable: '2100', taxReceivable: '1500' };
...
export const PURCHASE_SETTING_DEFS: readonly SettingDef[] = [
  {
    ...
    description: label('科目コードで指定: purchases=仕入高, payable=買掛金, taxReceivable=仮払消費税', 'By account code: purchases, payable, taxReceivable (input tax)'),
