...
export const WorkforceEvidenceModule = defineModule({
  name: 'workforce_evidence',
  label: label('従業員証憑', 'Employee evidence'),
  depends: ['workforce', 'attachment'],
  entities: [WorkforceReceipt],
  hooks: receiptHooks,
});
