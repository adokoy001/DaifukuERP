...
この付録は従来の通常制・外部確認控除方式を説明します。2026年の月額甲欄/確認本人条件による税保険自動算定、年末調整、開始前に確定する1か月変形・フレックスを別途追加しました。[付録I](appendix-i-fiscal-and-work-systems.md) の操作と対象/対象外を参照してください。固定残業代の精算、電子申告、銀行振込は含みません。従来方式の契約は [日本の労務制度](../domain/japan-workforce.md) と [設計仕様](../specs/workforce-platform.md) に残しています。
