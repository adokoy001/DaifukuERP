...
| [GitHub hosted runners](https://docs.github.com/en/actions/reference/runners/github-hosted-runners) | ubuntu-24.04/x64・ubuntu-24.04-arm、windows-2025/x64、macos-15-intel/x64・macos-15/arm64の5種類を実受入環境にする。開発者PCへ本番サービスを導入して試験しない。 |
