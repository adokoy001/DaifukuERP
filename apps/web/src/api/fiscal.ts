...
export const useFiscalBoard = (enabled: boolean) =>
  useWorkforceRead<FiscalBoard>('workforce.fiscal_board', { taxYear: 2026 }, enabled);
export const useMyFiscal = (enabled: boolean) =>
  useWorkforceRead<MyFiscal>('workforce.my_fiscal_portal', { taxYear: 2026 }, enabled);
