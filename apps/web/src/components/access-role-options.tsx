...
Object.assign(labels, { workforce_employee: { ja: '従業員（本人）', en: 'Employee (self)' }, workforce_manager: { ja: '拠点の勤怠・申請管理', en: 'Site workforce manager' }, workforce_hr: { ja: '本部の人事・労務', en: 'Headquarters HR' }, workforce_payroll: { ja: '給与担当', en: 'Payroll administrator' } });
