...
describe('台本: 個人事業（デザイン事務所）の 2026年10月 (docs/domain/scenario-kojin.md)', () => {
  it('1. 会計年度 2026（accounting.open_fiscal_year）・モジュール登録・全シード（system context, モジュール順）・会社設定（tax.rounding は l10n/jp 既定, sales.issuer）', async () => {
    ...
    expect(modules.map((m) => m.name)).toEqual(['partner', 'product', 'tax', 'accounting', 'attachment', 'sales', 'purchase', 'payment', 'inventory', 'contract', 'workforce', 'workforce_evidence', 'industry_operations', 'pos_integration', 'group_accounting', 'franchise', 'edge', 'l10n_jp']);
