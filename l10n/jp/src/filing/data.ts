...
export const HOT010_SOURCES = [
  'https://www.e-tax.nta.go.jp/hojin/gimuka/csv_jyoho4.htm',
  'https://www.e-tax.nta.go.jp/hojin/gimuka/csv_jyoho4_5_1.pdf',
...
const group = (
  ...
  level: number,
  statement: 'BS' | 'PL' = 'BS',
): FilingCategory => ({ key, label, accountTypes: [type], title, total, level, statement });
...
export const PAYROLL_PREPARATION_SOURCES = [
  'https://www.nta.go.jp/publication/pamph/hotei/tebiki2026/PDF/02.pdf',
...
export const FILING_REFERENCE_ARTIFACTS = [
  {
    url: HOT010_SOURCES[1] as string,
    sha256: 'c435332bd1e52da6f424beca16a4ce1ddf5a3b3ba8c8a5d373f82c2f4d71575f',
    verifiedOn: '2026-09-13',
    version: 'HOT010-3.0-record',
  },
  {
    url: HOT010_SOURCES[2] as string,
    sha256: '706805b94dfe50b4ef36ec31b4087487a1460d7837df040cc2441572974a3582',
    verifiedOn: '2026-09-13',
    version: 'HOT010-3.0-BS-10',
  },
  {
    url: HOT010_SOURCES[3] as string,
    sha256: '1041373f8fa5fad25265a55e902ecd7cbb1604b6a8e8e12924fb771e046a2929',
    verifiedOn: '2026-09-13',
    version: 'HOT010-3.0-PL-10',
  },
  {
    url: PAYROLL_PREPARATION_SOURCES[0] as string,
    sha256: '1128cae9c8b171df5c2fa3d12c0acb288540e9876f2d21fb6cf528ff11d2af62',
    verifiedOn: '2026-09-13',
    version: 'NTA-2026-payroll-guide',
  },
];
