...
export const RestaurantWasteLine = defineEntity({
  ...
  fields: {
    ...
    reason: f.enum(['spoilage', 'preparation', 'other'], { label: label('理由', 'Reason'), required: true, default: 'spoilage', labels: { spoilage: label('期限・品質', 'Spoilage'), preparation: label('調理ロス', 'Preparation loss'), other: label('その他', 'Other') } }),
