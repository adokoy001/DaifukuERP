...
export const INDUSTRY_PROFILES = [wholesale, manufacturing, construction, logistics, hospitality, clinic, careService, education, professionalService, beautySalon] as const;
