...
export const FarmSeason = defineDocument({
  ...
  views: {
    list: ['name', 'fieldId', 'cropId', 'startDate', 'endDate', 'closedDate'],
    search: ['name'],
    form: [['name'], ['fieldId', 'cropId'], ['startDate', 'endDate', 'closedDate'], ['note']],
  },
});
